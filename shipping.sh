...
mysql -h mysql.deepthi.tech -uroot -pRoboShop@1 < /app/db/schema.sql &>>$LOG_FILE
mysql -h mysql.deepthi.tech -uroot -pRoboShop@1 < /app/db/app-user.sql &>>$LOG_FILE
mysql -h mysql.deepthi.tech -uroot -pRoboShop@1 < /app/db/master-data.sql &>>$LOG_FILE
